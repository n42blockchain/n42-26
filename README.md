...
- **reth v2.4.1 Integration**: Tracks `n42blockchain/reth` branch `chore/reth-upstream-20260726` at `91725e3aa`, including post-release upstream fixes plus N42-specific payload-cache/QMDB patches; revmc/LLVM JIT remains explicit opt-in
...
- N42 `reth` 2.4.1 fork checked out at `../reth` (`91725e3aa8f2`)
...
test "$(git -C ../reth rev-parse HEAD)" = "91725e3aa8f2a0bbc5a425e931a2f2b2f31b2a7b"
```
