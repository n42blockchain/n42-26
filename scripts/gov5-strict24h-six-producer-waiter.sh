...
linkage="$runtime/evidence/runtime28-strict24h-six-producer-linkage.json"
failure="$runtime/evidence/runtime28-strict24h-six-producer-full-range-failure.json"
