...
expected_gov_sha="${N42_QUAL_EXPECTED_GOV_SHA:-19dfa6290bfb98fe722a7f47456e42fa173caf447566d05c946d53398a292036}"
...
expected_gov_upstream_sha="${N42_QUAL_EXPECTED_GOV_UPSTREAM_SHA:-5afabac1f431cf22b0f2d3902e80fc9bb094235c}"
expected_gov_candidate_sha="${N42_QUAL_EXPECTED_GOV_CANDIDATE_SHA:-54c55fa05b5c59bedc700e2d351de8e68fd8e15f}"
