...
echo "   Content: include crates/n42-mobile-ffi/include/n42_mobile.h"
echo ""
echo "3. Set Swift Compiler → Objective-C Bridging Header to the header path above."
echo ""
echo "See crates/n42-mobile-ffi/include/n42_mobile.h and src/ios.rs for integration details."
