...
| Fault/rejoin/epoch soak | In progress | Authoritative latest-main runtime27 strict window began 2026-08-03T09:49:44Z; eight-hour milestone passed with 953 samples, 3,192 blocks, max lag two, 535 Rust `5+5` commits, zero transactions/failures, and guarded burst/restart/latest-Reth closure still armed |
