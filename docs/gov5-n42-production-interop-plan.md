...
| Fault/rejoin/epoch soak | In progress | Authoritative latest-main runtime27 strict window began 2026-08-03T09:49:44Z; corrected two-hour milestone passed with 254 samples, 864 blocks, max lag two, 148 Rust `5+5` commits, zero transactions/failures, and guarded burst/restart/latest-Reth closure still armed |
