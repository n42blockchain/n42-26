...
| Fault/rejoin/epoch soak | In progress | Authoritative latest-main runtime27 strict window began 2026-08-03T09:49:44Z; seven-hour milestone passed with 833 samples, 2,784 blocks, max lag two, 467 Rust `5+5` commits, zero transactions/failures, and guarded burst/restart/latest-Reth closure still armed |
