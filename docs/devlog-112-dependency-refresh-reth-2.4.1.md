...
The combined Gov5 interoperability candidate adds its interop-only dependency edges; its
regenerated lockfile SHA-256 is
`fddf9bd028c0013d63fcba1709b179b41700c59f22e769f51f8537ca28ab3dc1`.
...
After merging the complete dependency series into the Gov5 interoperability branch, the combined
candidate repeated the locked all-target check, passed 1,434 workspace tests with 8 intentional
ignores and zero failures, and passed locked all-target Clippy with warnings denied.
